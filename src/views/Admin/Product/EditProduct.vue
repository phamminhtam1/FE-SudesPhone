    ...
    <div class="grid md:grid-cols-2 gap-10 border bg-white border-zinc-300 px-7 py-3 rounded-xl">
      ...
      <div>
        ...
        <div class="mb-6">
          ...
          <input v-model="name" type="text" class="w-full border-2 border-zinc-400 bg-white px-3 h-10" />
        ...
        <div class="mb-6">
          <label class="font-medium text-zinc-700 mb-1 block">Mô tả ngắn <span
              class="text-red-500 ml-1">*</span></label>
          <textarea v-model="short_desc" rows="3" class="w-full border-2 border-zinc-400 bg-white px-3 py-2"></textarea>
        ...
        <div class="mb-6">
          <label class="font-medium text-zinc-700 mb-1 block">Mô tả chi tiết <span
              class="text-red-500 ml-1">*</span></label>
          <textarea v-model="long_desc" rows="5" class="w-full border-2 border-zinc-400 bg-white px-3 py-2"></textarea>
        ...
        <div class="mb-6">
          <label class="font-medium text-zinc-700 mb-1 block">Từ khoá SEO <span
              class="text-red-500 ml-1">*</span></label>
          <input v-model="keywords" type="text" class="w-full border-2 border-zinc-400 bg-white px-3 h-10" />
          ...
          <div class="mt-3 flex flex-wrap gap-3">
            <div v-for="(p, idx) in previews" :key="idx" class="relative group">
              ...
              <button @click.prevent="removeImage(idx)"
                class="absolute -top-2 -right-2 bg-red-500 text-white rounded-xl w-[25px] p-1 text-xs hover:bg-red-600">
                ✕
              </button>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <input v-model="price" type="number" class="w-full border-2 border-zinc-400 bg-white px-3 h-10" />
          ...
          <div>
            ...
            <input v-model="discount_price" type="number" class="w-full border-2 border-zinc-400 bg-white px-3 h-10" />
        ...
        <div class="grid grid-cols-1 gap-4 mb-6">
          <div>
            <label class="font-medium text-zinc-700 mb-1 block">Bảo hành (tháng)<span
                class="text-red-500 ml-1">*</span></label>
            <input v-model="warranty_months" type="number" class="w-full border-2 border-zinc-400 bg-white px-3 h-10" />
        ...
        <div class="mb-6">
          ...
          <select v-model="selectedCategory" class="w-full border-2 border-zinc-400 bg-white px-3 h-10">
        ...
        <div class="mb-6">
          ...
          <div v-for="(spec, index) in specs" :key="index" class="flex items-center gap-2 mb-3">
            <input v-model="spec.spec_key" type="text" placeholder="Thuộc tính"
              class="w-[45%] border-2 border-zinc-400 bg-white px-3 h-10" />
